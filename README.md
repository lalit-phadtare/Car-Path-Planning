...
* [uWebSockets](https://github.com/uWebSockets/uWebSockets)
  ...
  * If you install from source, checkout to commit `e94b6e1`, i.e.
    ...
    ```
* spline library header downloaded from https://kluge.in-chemnitz.de/opensource/spline/
...
* The suggestion in class videos to using spline was really useful. I can incorporate the lane change information in calculating future anchor points for the spline equation. This provides a smooth transition between lanes.

* There is some confusion as how the accel. values were calculated. 5m/s2 is used as it worked practically. 
